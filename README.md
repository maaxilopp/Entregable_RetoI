...
El segundo paso es inicializar la aplicación en la terminal npm start
...
Como pedía la consigna, utilizé Electron y SQlite para hacer la aplicación. Intenté que sea esteticamente agradable y funcional a la vez.

## Cosas que no incluí

No incluí ningún extra, aunque me hubiera gustado poner una gráfica. Es mi primer proyecto usando Java, Electron y SQlite por lo que decidí hacer algo sencillo.

## Conclusion

Fue un muy buen proyecto para continuar desarrollando mi pensamiento computacional. Me gustó mucho jugar con SQlite, HTML y CSS. Agradezco esta capacitación para poder colaborar con el resto de mis compañeros en el reto. 
